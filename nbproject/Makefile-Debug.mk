...
LDLIBSOPTIONS=-lleveldb -lthrift -lthriftnb -levent -lpthread
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/databaseservice: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/databaseservice ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/DatabaseModelFactory.o: DatabaseModelFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DatabaseModelFactory.o DatabaseModelFactory.cpp
...
${OBJECTDIR}/DatabaseService_server.o: DatabaseService_server.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DatabaseService_server.o DatabaseService_server.cpp

${OBJECTDIR}/LevelDBModel.o: LevelDBModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LevelDBModel.o LevelDBModel.cpp

${OBJECTDIR}/databaseservice_constants.o: databaseservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/databaseservice_constants.o databaseservice_constants.cpp

${OBJECTDIR}/databaseservice_types.o: databaseservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/databaseservice_types.o databaseservice_types.cpp
